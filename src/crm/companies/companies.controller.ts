...
export class CompaniesController {
  ...
  @ApiResponse({
    status: 400,
    description: 'Bad request - Domain already exists',
  })
  ...
  @ApiOperation({
    summary: 'Get all companies with pagination, filtering, and sorting',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Search in name, domain, industry',
  })
  @ApiQuery({
    name: 'sortBy',
    required: false,
  ...
  @ApiResponse({
    status: 400,
    description: 'Cannot delete company with contacts or subsidiaries',
  })
  @Delete(':id')
